...
from Anaconda_bus_APP.models import MenuPrice, Category, Topping_qty, Size, Topping, Cart
...
import csv
from Anaconda_bus_APP.models import MenuPrice, Category, Topping_qty, Size
f = open("products.csv")
reader = csv.reader(f)
for category, name, topping_qty, size, price in reader:
  if topping_qty == "" and size =="":
...
# price list import
import csv
from Anaconda_bus_APP.models import Price_List
...
# item list import
import csv
from Anaconda_bus_APP.models import Item_List, Price_List, Category
f = open("itemlist.csv")
reader = csv.reader(f)
